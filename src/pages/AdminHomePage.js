...
export default function AdminHomePage({ laporan = [] }) { 
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl p-6 md:p-8 shadow-lg">
        <h2 className="text-2xl md:text-3xl font-bold mb-2">Selamat Datang, Admin!</h2>
